...
create procedure TigPubSubCreateNode(service_jid varchar(2049), node_name varchar(1024),
	node_type int, node_creator varchar(2049), node_conf varchar(32672), collection_id bigint, ts timestamp, component_name varchar(190))
...
-- QUERY START:
create procedure TigPubSubRemoveService(service_jid varchar(2049), component_name varchar(190))
	PARAMETER STYLE JAVA
	LANGUAGE JAVA
	MODIFIES SQL DATA
	DYNAMIC RESULT SETS 1
